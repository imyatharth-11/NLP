Gen_Embeddings file is used to create embeddings for the resume text that is parsed using the transformer encoder. The embeddings created are saved in a pickle file.
